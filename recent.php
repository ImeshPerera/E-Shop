        ...
        <div class="row">
            <div class="col-12 border border-1 border-secondary">
                <div class="row">
                    <!-- topic start -->
                    <div class="col-12">
                        <label class="form-label  fs-1 fw-bolder">Recent <i class="bi bi-clock"></i></label>
                        <hr class="hrbreak1" />
                    </div>
                    <!-- topic close -->
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-12 col-md-10">                
                                <div class="d-flex mb-3">
                                    <input type="text" class="form-control" id="recentListSearch" placeholder="Search in Recent" />
                                    <button onclick="UserRecentSearch();" class="btn btn-outline-primary ms-2-5">Search</button>
                                </div>
                            </div>
                            <hr class="hrbreak1" />
                            ...
                            <div class="col-12 col-lg-2 border-2 border-lg-end border-primary mb-2">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb ps-3">
                                        ...
                                        <li class="breadcrumb-item active nav-link p-0 point-none" aria-current="page">Recent</li>
                                    </ol>
                                </nav>
                                <nav class="nav justify-content-center flex-lg-column">
                                    <a class="nav-link active point-none" aria-current="page">Recently Viewed</a>
                            ...
                            <div class="col-12 col-lg-9 d-flex justify-content-center" id="RecentSearchFill">
                                <div class="row text-center" style="height: 300px;">
                                    ...
                                    <label class="form-label fs-1 mb-3 fw-bolder">You have no items in Recent</label>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-lg-10">
                                <div id="RecentSearchFill" class="row g-2">
                                <?php 
                                for($n = 0; $n < $WishNum; $n++){
